...
export default {
  ...
  mounted() {
    ...
    var responseApi;
    axios.get('https://api.spotify.com/v1/audio-analysis/6rqhFgbbKwnb9MLmUQDhG6?access_token=BQALfj8oV8SCbZseL_k58mO46JrSBj0YCQUZKrjmQGNpHOmRKFbGec7ykl8PQPnz8bNQctQworQDcO8wL4AxeYUHZsrQTbR4hMX0C0tsEvHAxnqKDKEGxIe8UowXh-jpnLWg-d2ZHuiVpapQirVovY8M_eI1028w-t7IKy8zUeCss5AMRhYWLWIYnJjC2LY0tHQrWoO72qI-0IPCEJNoe71mF1docUxL_18y6dMW-AmtvqU6Lqm0PYgif-Te3vz1_MUVrEQjNXxCvcbrk7leAM0lvWGHUmRrmbSwwmCVUXGj').then(resp => {
